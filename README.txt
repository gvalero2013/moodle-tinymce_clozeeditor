...
As of Moodle version 2.5, the plugin can be deployed from within Moodle, 
by uploading the cloze editor ZIP file (see http://docs.moodle.org/25/en/Installing_add-ons#Installing_via_uploaded_ZIP_file). 
